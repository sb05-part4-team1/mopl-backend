...
class ContentServiceTest {
    ...
    class CreateTest {
        ...
        @Test
        @DisplayName("콘텐츠를 저장하고 결과를 반환한다")
        void withModelAndTags_returnsSavedModel() {
            ...
            given(contentRepository.save(contentModel, tags)).willReturn(contentModel);
            ...
            then(contentRepository).should().save(contentModel, tags);
        }
    }
}
