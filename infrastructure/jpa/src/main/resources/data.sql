...
-- 1. 사용자 (Users)
-- =============================================
MERGE INTO users (id, created_at, deleted_at, updated_at, auth_provider, email, name, password, profile_image_path, role, locked) KEY(id)
VALUES
    (CAST('019439a0-0001-7000-8000-000000000001' AS UUID), DATEADD('DAY', -90, NOW()), NULL, DATEADD('DAY', -90, NOW()), 'EMAIL', 'admin@mopl.com', '이윤수', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0001-7000-8000-000000000001/31a154c4-813f-48de-a144-e554b85396c0_profile.png', 'ADMIN', FALSE),
    (CAST('019439a0-0002-7000-8000-000000000002' AS UUID), DATEADD('DAY', -60, NOW()), NULL, DATEADD('DAY', -5, NOW()), 'EMAIL', 'user1@mopl.com', '김수연', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019bee84-e567-77cd-b7a9-be9e885df765/1.png', 'USER', FALSE),
    (CAST('019439a0-0003-7000-8000-000000000003' AS UUID), DATEADD('DAY', -45, NOW()), NULL, DATEADD('DAY', -3, NOW()), 'EMAIL', 'user2@mopl.com', '류승민', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0003-7000-8000-000000000003/98954bec-acad-41d5-a559-9e98496b76fa_profile.png', 'USER', FALSE),
    (CAST('019439a0-0004-7000-8000-000000000004' AS UUID), DATEADD('DAY', -30, NOW()), NULL, DATEADD('DAY', -1, NOW()), 'GOOGLE', 'user3@gmail.com', '박지석', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0004-7000-8000-000000000004/d6daf9d1-fd9c-4910-bb3e-8679dffed59a_profile.png', 'USER', FALSE),
    (CAST('019439a0-0005-7000-8000-000000000005' AS UUID), DATEADD('DAY', -14, NOW()), NULL, DATEADD('HOUR', -12, NOW()), 'KAKAO', 'user4@kakao.com', '박지성', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0005-7000-8000-000000000005/823a0379-052e-45bc-a975-e1894b53c3b3_profile.png', 'USER', FALSE),
    (CAST('019439a0-0006-7000-8000-000000000006' AS UUID), DATEADD('DAY', -10, NOW()), NULL, DATEADD('DAY', -2, NOW()), 'EMAIL', 'user5@mopl.com', '임재혁', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0006-7000-8000-000000000006/b475a73f-c33a-41db-bc1e-1c5b3ab50995_profile.png', 'USER', FALSE),
    (CAST('019439a0-0007-7000-8000-000000000007' AS UUID), DATEADD('DAY', -7, NOW()), NULL, DATEADD('DAY', -2, NOW()), 'EMAIL', 'locked@mopl.com', '이해성', '$2a$10$gCRpIif4.HK5xSpWLeNJ8OCGEaAjnI5Rv33SZs5tTb6F7EyMpjjWe', 'users/019439a0-0007-7000-8000-000000000007/68f7ad1c-8c35-4ad8-b664-9d104399c066_profile.png', 'USER', TRUE);

-- =============================================
-- 2. 태그 (Tags)
-- =============================================
MERGE INTO tags (id, created_at, deleted_at, name) KEY(id)
VALUES
...
-- 3. 콘텐츠 (Contents) - 영화
-- =============================================
MERGE INTO contents (id, created_at, deleted_at, updated_at, type, title, description, thumbnail_path, review_count, average_rating, popularity_score) KEY(id)
VALUES
    (CAST('019439c0-0001-7000-8000-000000000001' AS UUID), DATEADD('DAY', -85, NOW()), NULL, DATEADD('DAY', -85, NOW()), 'movie', '세 가지 색: 레드 (1994)', '발렌틴은 스위스의 제네바 대학 학생이며 파트 타임 모델로 일하고 있다. 그녀는 이웃들의 전화 통화를 도청하는 은퇴한 판사의 개를 부상시킨 후 우정을 쌓기 시작하고, 그 만남은 인생에서의 우연과 인연에 대해 생각하게 만든다.', 'contents/019439c0-0001-7000-8000-000000000001/a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d_thumbnail.webp', 2, 4.75, 4.54),
    (CAST('019439c0-0002-7000-8000-000000000002' AS UUID), DATEADD('DAY', -82, NOW()), NULL, DATEADD('DAY', -82, NOW()), 'movie', '사랑에 빠진 것처럼 (2012)', '도쿄의 고급스러운 바에서 사랑에 무뎌진 노인과 사랑을 갈망하는 젊은 여자가 만나 서로의 삶에 대한 관점에 영향을 주고받는다.', 'contents/019439c0-0002-7000-8000-000000000002/b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e_thumbnail.webp', 0, 0.0, 0.0),
...
-- 5. 플레이리스트 (Playlists)
-- =============================================
MERGE INTO playlists (id, created_at, deleted_at, updated_at, title, description, owner_id, subscriber_count) KEY(id)
VALUES
...
-- =============================================
MERGE INTO playlist_contents (id, created_at, deleted_at, playlist_id, content_id) KEY(id)
VALUES
...
-- =============================================
MERGE INTO playlist_subscribers (id, created_at, deleted_at, playlist_id, subscriber_id) KEY(id)
VALUES
...
-- 8. 팔로우 (Follows)
-- =============================================
MERGE INTO follows (id, created_at, deleted_at, follower_id, followee_id) KEY(id)
VALUES
    -- user1 -> user2, user3
...
-- 9. 리뷰 (Reviews)
-- =============================================
MERGE INTO reviews (id, created_at, deleted_at, updated_at, text, rating, content_id, author_id) KEY(id)
VALUES
    -- 세 가지 색: 레드 리뷰
...
-- 10. 알림 (Notifications)
-- =============================================
MERGE INTO notifications (id, created_at, deleted_at, title, content, level, receiver_id) KEY(id)
VALUES
...
-- 11. 대화 (Conversations)
-- =============================================
MERGE INTO conversations (id, created_at, deleted_at, updated_at) KEY(id)
VALUES
...
-- =============================================
MERGE INTO direct_messages (id, created_at, deleted_at, content, conversation_id, sender_id) KEY(id)
VALUES
    -- 대화 1: user1 <-> user2
...
-- =============================================
MERGE INTO read_statuses (id, created_at, deleted_at, last_read_at, conversation_id, participant_id) KEY(id)
VALUES
    -- 대화 1 참여자들
