...
-- 3. 콘텐츠 (Contents) - 영화
-- =============================================
INSERT INTO contents (id, created_at, deleted_at, updated_at, type, title, description, thumbnail_url)
VALUES
    (CAST('019439c0-0001-7000-8000-000000000001' AS UUID), DATEADD('DAY', -85, NOW()), NULL, DATEADD('DAY', -85, NOW()), 'MOVIE', '세 가지 색: 레드 (1994)', '발렌틴은 스위스의 제네바 대학 학생이며 파트 타임 모델로 일하고 있다. 그녀는 이웃들의 전화 통화를 도청하는 은퇴한 판사의 개를 부상시킨 후 우정을 쌓기 시작하고, 그 만남은 인생에서의 우연과 인연에 대해 생각하게 만든다.', 'http://localhost:8080/api/v1/files/display?path=contents/019439c0-0001-7000-8000-000000000001/a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d_thumbnail.png'),
