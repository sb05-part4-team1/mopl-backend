...
public class EmailService {
    ...
    public void sendTemporaryPassword(String to, String temporaryPassword, LocalDateTime expiresAt) {
        try {
    ...
    private String buildTemporaryPasswordEmailHtml(String temporaryPassword, LocalDateTime expiresAt) {
        ...
        return """
            ...
            <head>
                ...
                <style>
                    ...
                    .password-box { background-color: #f8f9fa; padding: 20px; border-radius: 5px; text-align: center; margin: 20px 0; border-left: 4px solid #007bff; }
